...
module.exports = function(){
	...
	require('../app/routes/server.routes.procedimiento.js')(app);
	require('../app/routes/server.routes.tipoPago.js')(app);
	require('../app/routes/server.routes.ingreso.js')(app);
	require('../app/routes/server.routes.factura.js')(app);

	require('../app/routes/server.routes.licitacion.js')(app);
	require('../app/routes/server.routes.compradirecta.js')(app);
	require('../app/routes/server.routes.producto.js')(app);
